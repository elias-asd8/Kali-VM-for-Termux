...
```bash
qemu-system-x86_64 -m 2048 -cpu max -smp 2 -hda kali.qcow2 -cdrom kali-linux-2025.4-installer-amd64.iso -boot d -vga std -device e1000,netdev=net0 -netdev user,id=net0 -vnc :1
```
